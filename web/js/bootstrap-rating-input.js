(function ($) {
    ...
    var clearClass = 'rating-clear',
            ...
            DEFAULTS = {
                ...
                'empty-value': 0,
                'iconLib': 'glyphicon',
                'activeIcon': 'glyphicon-star estrella_encendida',
                'inactiveIcon': 'glyphicon-star estrella_apagada',
                'clearable': false,
    ...
    function createRatingEl($input, options) {
        ...
        for (var i = options.min; i <= options.max; i++) {
            $ratingEl.append('<i style="font-size: 200%;text-align:center;" class="' + options.iconLib + '" data-value="' + i + '"></i>');
        }
