...
class RequerimientoForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->setWidget("presupuesto_min", new sfWidgetFormInputText(array("label" => "Precio (Q)"), array("class" => "form-control ken_number")));
        $this->setWidget("presupuesto_max", new sfWidgetFormInputText(array("label" => "Precio (Q)"), array("class" => "form-control ken_number")));
        ...
        $this->setWidget("nucleo_familiar", new sfWidgetFormInputText(array("label" => "Telefono del Cliente"), array("class" => "form-control ken_number")));
//        $this->setWidget("moneda_ingreso", new sfWidgetFormSelect(array('choices' => $monedas), array("class" => "form-control col-md-10")));
        $this->setWidget("ingresos", new sfWidgetFormInputText(array("label" => "Telefono del Cliente"), array("class" => "form-control calculo ken_number")));
        $this->setWidget("moneda_egresos", new sfWidgetFormSelect(array('choices' => $monedas), array("class" => "form-control col-md-10")));
        $this->setWidget("egresos", new sfWidgetFormInputText(array("label" => "Telefono del Cliente"), array("class" => "form-control calculo ken_number")));
        $this->setWidget("enganche", new sfWidgetFormInputText(array("label" => "Telefono del Cliente"), array("class" => "form-control calculo ken_number")));
        $this->setWidget("tasa_interes_anual", new sfWidgetFormInputText(array("label" => "Telefono del Cliente"), array("class" => "form-control calculo ken_number")));
        ...
        $this->setWidget("monto_financiar_maximo", new sfWidgetFormInputText(array("label" => "Telefono del Cliente"), array("class" => "form-control ken_number", "readonly" => true)));
        $this->setWidget("cuota_total_mensual_maxima", new sfWidgetFormInputText(array("label" => "Telefono del Cliente"), array("class" => "form-control ken_number", "readonly" => true)));
