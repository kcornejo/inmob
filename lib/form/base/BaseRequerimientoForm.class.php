...
abstract class BaseRequerimientoForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'moneda_ingreso'             => new sfWidgetFormPropelChoice(array('model' => 'Moneda', 'add_empty' => false)),
      'ingresos'                   => new sfWidgetFormInputText(),
      'moneda_egresos'             => new sfWidgetFormPropelChoice(array('model' => 'Moneda', 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'moneda_ingreso'             => new sfValidatorPropelChoice(array('model' => 'Moneda', 'column' => 'id')),
      'ingresos'                   => new sfValidatorNumber(array('required' => false)),
      'moneda_egresos'             => new sfValidatorPropelChoice(array('model' => 'Moneda', 'column' => 'id')),
