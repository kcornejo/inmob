...
class RequerimientoTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('MONEDA_INGRESO', 'MonedaIngreso', 'INTEGER', 'moneda', 'ID', true, null, null);
        $this->addColumn('INGRESOS', 'Ingresos', 'DOUBLE', false, null, null);
        $this->addForeignKey('MONEDA_EGRESOS', 'MonedaEgresos', 'INTEGER', 'moneda', 'ID', true, null, null);
    ...
    {
        $this->addRelation('MonedaRelatedByMonedaId', 'Moneda', RelationMap::MANY_TO_ONE, array('moneda_id' => 'id', ), null, null);
        $this->addRelation('MonedaRelatedByMonedaIngreso', 'Moneda', RelationMap::MANY_TO_ONE, array('moneda_ingreso' => 'id', ), null, null);
        $this->addRelation('MonedaRelatedByMonedaEgresos', 'Moneda', RelationMap::MANY_TO_ONE, array('moneda_egresos' => 'id', ), null, null);
