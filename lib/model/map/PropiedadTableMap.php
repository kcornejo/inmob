...
class PropiedadTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('DORMITORIO_SERVICIO', 'DormitorioServicio', 'INTEGER', false, null, null);
        $this->addColumn('ESTUDIO', 'Estudio', 'INTEGER', false, null, null);
        $this->addColumn('CISTERNA', 'Cisterna', 'INTEGER', false, null, null);
        ...
        $this->addColumn('LAVANDERIA', 'Lavanderia', 'INTEGER', false, null, null);
        ...
        $this->addColumn('PRECIO_NEGOCIABLE', 'PrecioNegociable', 'BOOLEAN', false, 1, null);
        $this->addColumn('FORMA_PAGO', 'FormaPago', 'VARCHAR', false, 255, null);
        $this->addColumn('GASTOS_ESCRITURA', 'GastosEscritura', 'BOOLEAN', false, 1, null);
