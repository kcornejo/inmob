...
class BancoTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('RELACION_CUOTA_INTERES', 'RelacionCuotaInteres', 'DOUBLE', false, null, null);
        $this->addColumn('SEGURO_BANCO', 'SeguroBanco', 'DOUBLE', false, null, null);
        $this->addColumn('FACTOR_CONSTRUCCION', 'FactorConstruccion', 'DOUBLE', false, null, null);
