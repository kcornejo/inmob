...
abstract class BasePropiedadPeer
{
    ...
    const ESTATUS = 'propiedad.ESTATUS';

    /** the column name for the USUARIO_ID field */
    const USUARIO_ID = 'propiedad.USUARIO_ID';

    /** the column name for the CANTIDAD_OFICINA field */
    const CANTIDAD_OFICINA = 'propiedad.CANTIDAD_OFICINA';

    /** the column name for the CANTIDAD_CUBICULO field */
    const CANTIDAD_CUBICULO = 'propiedad.CANTIDAD_CUBICULO';

    /** the column name for the CONTRATO field */
    const CONTRATO = 'propiedad.CONTRATO';

    /** the column name for the MANTENIMIENTO_RENTA field */
    const MANTENIMIENTO_RENTA = 'propiedad.MANTENIMIENTO_RENTA';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PropiedadPeer::ESTATUS);
            $criteria->addSelectColumn(PropiedadPeer::USUARIO_ID);
            $criteria->addSelectColumn(PropiedadPeer::CANTIDAD_OFICINA);
            $criteria->addSelectColumn(PropiedadPeer::CANTIDAD_CUBICULO);
            $criteria->addSelectColumn(PropiedadPeer::CONTRATO);
            $criteria->addSelectColumn(PropiedadPeer::MANTENIMIENTO_RENTA);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.MANTENIMIENTO_RENTA');
        }
    }
    ...
    public static function doCountJoinUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PropiedadPeer::USUARIO_ID, UsuarioPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Propiedad objects pre-filled with their Usuario objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Propiedad objects.
    ...
    public static function doSelectJoinUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Propiedad) to $obj2 (Usuario)
                $obj2->addPropiedad($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key6 !== null) {
                ...
                // Add the $obj1 (Propiedad) to the collection in $obj6 (Usuario)
                $obj6->addPropiedad($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptMoneda(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = PropiedadPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Propiedad) to the collection in $obj5 (Usuario)
                $obj5->addPropiedad($obj1);
    ...
    /**
     * Selects a collection of Propiedad objects pre-filled with all related objects except Usuario.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
