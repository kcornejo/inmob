...
abstract class BaseConfiguracionPeer
{
    ...
    const HOST = 'configuracion.HOST';

    /** the column name for the ENCRIPTACION field */
    const ENCRIPTACION = 'configuracion.ENCRIPTACION';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Host', 'Encriptacion', 'Puerto', 'Usuario', 'Clave', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'host', 'encriptacion', 'puerto', 'usuario', 'clave', ),
        BasePeer::TYPE_COLNAME => array (ConfiguracionPeer::ID, ConfiguracionPeer::HOST, ConfiguracionPeer::ENCRIPTACION, ConfiguracionPeer::PUERTO, ConfiguracionPeer::USUARIO, ConfiguracionPeer::CLAVE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'HOST', 'ENCRIPTACION', 'PUERTO', 'USUARIO', 'CLAVE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'host', 'encriptacion', 'puerto', 'usuario', 'clave', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Host' => 1, 'Encriptacion' => 2, 'Puerto' => 3, 'Usuario' => 4, 'Clave' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'host' => 1, 'encriptacion' => 2, 'puerto' => 3, 'usuario' => 4, 'clave' => 5, ),
        BasePeer::TYPE_COLNAME => array (ConfiguracionPeer::ID => 0, ConfiguracionPeer::HOST => 1, ConfiguracionPeer::ENCRIPTACION => 2, ConfiguracionPeer::PUERTO => 3, ConfiguracionPeer::USUARIO => 4, ConfiguracionPeer::CLAVE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'HOST' => 1, 'ENCRIPTACION' => 2, 'PUERTO' => 3, 'USUARIO' => 4, 'CLAVE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'host' => 1, 'encriptacion' => 2, 'puerto' => 3, 'usuario' => 4, 'clave' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ConfiguracionPeer::HOST);
            $criteria->addSelectColumn(ConfiguracionPeer::ENCRIPTACION);
            $criteria->addSelectColumn(ConfiguracionPeer::PUERTO);
            $criteria->addSelectColumn(ConfiguracionPeer::USUARIO);
            $criteria->addSelectColumn(ConfiguracionPeer::CLAVE);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.HOST');
            $criteria->addSelectColumn($alias . '.ENCRIPTACION');
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(ConfiguracionPeer::ID);
            if ($value) {
                $selectCriteria->add(ConfiguracionPeer::ID, $value, $comparison);
            } else {
