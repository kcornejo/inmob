...
abstract class BasePropiedad extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the mantenimiento_renta field.
     * @var        double
     */
    protected $mantenimiento_renta;
    ...
    /**
     * Get the [mantenimiento_renta] column value.
     *
     * @return double
     */
    public function getMantenimientoRenta()
    {
        return $this->mantenimiento_renta;
    }
    ...
    public function setEstatus($v)
    {
        ...
        if ($this->estatus !== $v) {
            $this->estatus = $v;
            $this->modifiedColumns[] = PropiedadPeer::ESTATUS;
        }
    ...
    public function setUsuarioId($v)
    {
        ...
        if ($this->usuario_id !== $v) {
            $this->usuario_id = $v;
            $this->modifiedColumns[] = PropiedadPeer::USUARIO_ID;
        }
    ...
    public function setCantidadOficina($v)
    {
        ...
        if ($this->cantidad_oficina !== $v) {
            ...
            $this->modifiedColumns[] = PropiedadPeer::CANTIDAD_OFICINA;
        }
    ...
    public function setCantidadCubiculo($v)
    {
        ...
        if ($this->cantidad_cubiculo !== $v) {
            ...
            $this->modifiedColumns[] = PropiedadPeer::CANTIDAD_CUBICULO;
        }
    ...
    /**
     * Sets the value of the [contrato] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function setContrato($v)
    {
        ...
        if ($this->contrato !== $v) {
            $this->contrato = $v;
            $this->modifiedColumns[] = PropiedadPeer::CONTRATO;
        }
    ...
    /**
     * Set the value of [mantenimiento_renta] column.
     *
     * @param double $v new value
     * @return Propiedad The current object (for fluent API support)
     */
    public function setMantenimientoRenta($v)
    {
        if ($v !== null) {
            $v = (double) $v;
        }

        if ($this->mantenimiento_renta !== $v) {
            $this->mantenimiento_renta = $v;
            $this->modifiedColumns[] = PropiedadPeer::MANTENIMIENTO_RENTA;
        }


        return $this;
    } // setMantenimientoRenta()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->estatus = ($row[$startcol + 54] !== null) ? (string) $row[$startcol + 54] : null;
            $this->usuario_id = ($row[$startcol + 55] !== null) ? (int) $row[$startcol + 55] : null;
            $this->cantidad_oficina = ($row[$startcol + 56] !== null) ? (int) $row[$startcol + 56] : null;
            $this->cantidad_cubiculo = ($row[$startcol + 57] !== null) ? (int) $row[$startcol + 57] : null;
            $this->contrato = ($row[$startcol + 58] !== null) ? (boolean) $row[$startcol + 58] : null;
            $this->mantenimiento_renta = ($row[$startcol + 59] !== null) ? (double) $row[$startcol + 59] : null;
            $this->resetModified();
            ...
            return $startcol + 60; // 60 = PropiedadPeer::NUM_HYDRATE_COLUMNS.
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->propiedadImagensScheduledForDeletion !== null) {
                if (!$this->propiedadImagensScheduledForDeletion->isEmpty()) {
                    PropiedadImagenQuery::create()
                        ->filterByPrimaryKeys($this->propiedadImagensScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PropiedadPeer::ESTATUS)) {
            $modifiedColumns[':p' . $index++]  = '`ESTATUS`';
        }
        if ($this->isColumnModified(PropiedadPeer::USUARIO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USUARIO_ID`';
        }
        if ($this->isColumnModified(PropiedadPeer::CANTIDAD_OFICINA)) {
            $modifiedColumns[':p' . $index++]  = '`CANTIDAD_OFICINA`';
        }
        if ($this->isColumnModified(PropiedadPeer::CANTIDAD_CUBICULO)) {
            $modifiedColumns[':p' . $index++]  = '`CANTIDAD_CUBICULO`';
        }
        if ($this->isColumnModified(PropiedadPeer::CONTRATO)) {
            $modifiedColumns[':p' . $index++]  = '`CONTRATO`';
        }
        if ($this->isColumnModified(PropiedadPeer::MANTENIMIENTO_RENTA)) {
            $modifiedColumns[':p' . $index++]  = '`MANTENIMIENTO_RENTA`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`CANTIDAD_CUBICULO`':
                        ...
                        break;
                    case '`CONTRATO`':
                        $stmt->bindValue($identifier, (int) $this->contrato, PDO::PARAM_INT);
                        break;
                    case '`MANTENIMIENTO_RENTA`':
                        $stmt->bindValue($identifier, $this->mantenimiento_renta, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 58:
                ...
                break;
            case 59:
                return $this->getMantenimientoRenta();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[54] => $this->getEstatus(),
            $keys[55] => $this->getUsuarioId(),
            $keys[56] => $this->getCantidadOficina(),
            $keys[57] => $this->getCantidadCubiculo(),
            $keys[58] => $this->getContrato(),
            $keys[59] => $this->getMantenimientoRenta(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 58:
                ...
                break;
            case 59:
                $this->setMantenimientoRenta($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[54], $arr)) $this->setEstatus($arr[$keys[54]]);
        if (array_key_exists($keys[55], $arr)) $this->setUsuarioId($arr[$keys[55]]);
        if (array_key_exists($keys[56], $arr)) $this->setCantidadOficina($arr[$keys[56]]);
        if (array_key_exists($keys[57], $arr)) $this->setCantidadCubiculo($arr[$keys[57]]);
        if (array_key_exists($keys[58], $arr)) $this->setContrato($arr[$keys[58]]);
        if (array_key_exists($keys[59], $arr)) $this->setMantenimientoRenta($arr[$keys[59]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PropiedadPeer::ESTATUS)) $criteria->add(PropiedadPeer::ESTATUS, $this->estatus);
        if ($this->isColumnModified(PropiedadPeer::USUARIO_ID)) $criteria->add(PropiedadPeer::USUARIO_ID, $this->usuario_id);
        if ($this->isColumnModified(PropiedadPeer::CANTIDAD_OFICINA)) $criteria->add(PropiedadPeer::CANTIDAD_OFICINA, $this->cantidad_oficina);
        if ($this->isColumnModified(PropiedadPeer::CANTIDAD_CUBICULO)) $criteria->add(PropiedadPeer::CANTIDAD_CUBICULO, $this->cantidad_cubiculo);
        if ($this->isColumnModified(PropiedadPeer::CONTRATO)) $criteria->add(PropiedadPeer::CONTRATO, $this->contrato);
        if ($this->isColumnModified(PropiedadPeer::MANTENIMIENTO_RENTA)) $criteria->add(PropiedadPeer::MANTENIMIENTO_RENTA, $this->mantenimiento_renta);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMantenimientoRenta($this->getMantenimientoRenta());
    ...
    public function getUsuario(PropelPDO $con = null)
    {
        if ($this->aUsuario === null && ($this->usuario_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuario->addPropiedads($this);
             */
        }
    ...
    public function setNegocios(PropelCollection $negocios, PropelPDO $con = null)
    {
        ...
        foreach ($this->negociosScheduledForDeletion as $negocioRemoved) {
            $negocioRemoved->setPropiedad(null);
        }
     ...
     * @return PropelObjectCollection|Negocio[] List of Negocio objects
     */
    public function getNegociosJoinRequerimiento($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = NegocioQuery::create(null, $criteria);
