...
abstract class BasePropiedad extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the precio_negociable field.
     * @var        boolean
     */
    protected $precio_negociable;
    ...
    /**
     * The value for the gastos_escritura field.
     * @var        boolean
     */
    protected $gastos_escritura;
    ...
    /**
     * Get the [precio_negociable] column value.
     *
     * @return boolean
     */
    public function getPrecioNegociable()
    {
        return $this->precio_negociable;
    }
    ...
    /**
     * Get the [gastos_escritura] column value.
     *
     * @return boolean
     */
    public function getGastosEscritura()
    {
        return $this->gastos_escritura;
    }
    ...
    /**
     * Set the value of [dormitorio_servicio] column.
     *
     * @param int $v new value
     * @return Propiedad The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [cisterna] column.
     *
     * @param int $v new value
     * @return Propiedad The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [lavanderia] column.
     *
     * @param int $v new value
     * @return Propiedad The current object (for fluent API support)
     */
    ...
    /**
     * Sets the value of the [precio_negociable] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return Propiedad The current object (for fluent API support)
     */
    public function setPrecioNegociable($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->precio_negociable !== $v) {
            $this->precio_negociable = $v;
            $this->modifiedColumns[] = PropiedadPeer::PRECIO_NEGOCIABLE;
        }
    ...
    /**
     * Sets the value of the [gastos_escritura] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return Propiedad The current object (for fluent API support)
     */
    public function setGastosEscritura($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
                $v = in_array(strtolower($v), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        ...
        if ($this->gastos_escritura !== $v) {
            $this->gastos_escritura = $v;
            $this->modifiedColumns[] = PropiedadPeer::GASTOS_ESCRITURA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->dormitorio_servicio = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            $this->estudio = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
            $this->cisterna = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            ...
            $this->lavanderia = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
            ...
            $this->mi_comision = ($row[$startcol + 24] !== null) ? (double) $row[$startcol + 24] : null;
            $this->comision_compartida = ($row[$startcol + 25] !== null) ? (double) $row[$startcol + 25] : null;
            $this->nombre_cliente = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->correo_cliente = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->telefono_cliente = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->departamento_id = ($row[$startcol + 29] !== null) ? (int) $row[$startcol + 29] : null;
            $this->municipio_id = ($row[$startcol + 30] !== null) ? (int) $row[$startcol + 30] : null;
            $this->zona = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
            $this->km = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
            $this->direccion = ($row[$startcol + 33] !== null) ? (string) $row[$startcol + 33] : null;
            $this->seguridad = ($row[$startcol + 34] !== null) ? (double) $row[$startcol + 34] : null;
            $this->accesos = ($row[$startcol + 35] !== null) ? (double) $row[$startcol + 35] : null;
            $this->agua = ($row[$startcol + 36] !== null) ? (double) $row[$startcol + 36] : null;
            $this->transporte_publico = ($row[$startcol + 37] !== null) ? (double) $row[$startcol + 37] : null;
            $this->transito_vehicular = ($row[$startcol + 38] !== null) ? (double) $row[$startcol + 38] : null;
            $this->comunidades_colidantes = ($row[$startcol + 39] !== null) ? (double) $row[$startcol + 39] : null;
            $this->areas_recreacion = ($row[$startcol + 40] !== null) ? (double) $row[$startcol + 40] : null;
            $this->precio_negociable = ($row[$startcol + 41] !== null) ? (boolean) $row[$startcol + 41] : null;
            $this->forma_pago = ($row[$startcol + 42] !== null) ? (string) $row[$startcol + 42] : null;
            $this->gastos_escritura = ($row[$startcol + 43] !== null) ? (boolean) $row[$startcol + 43] : null;
            ...
            return $startcol + 48; // 48 = PropiedadPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PropiedadPeer::PRECIO_NEGOCIABLE)) {
            $modifiedColumns[':p' . $index++]  = '`PRECIO_NEGOCIABLE`';
        }
        if ($this->isColumnModified(PropiedadPeer::FORMA_PAGO)) {
            $modifiedColumns[':p' . $index++]  = '`FORMA_PAGO`';
        }
        if ($this->isColumnModified(PropiedadPeer::GASTOS_ESCRITURA)) {
            $modifiedColumns[':p' . $index++]  = '`GASTOS_ESCRITURA`';
        }
        if ($this->isColumnModified(PropiedadPeer::CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`DORMITORIO_SERVICIO`':
                        $stmt->bindValue($identifier, $this->dormitorio_servicio, PDO::PARAM_INT);
                        break;
                    case '`ESTUDIO`':
                        $stmt->bindValue($identifier, $this->estudio, PDO::PARAM_INT);
                        break;
                    case '`CISTERNA`':
                        $stmt->bindValue($identifier, $this->cisterna, PDO::PARAM_INT);
                        break;
                    ...
                    case '`CANTIDAD_PATIO`':
                        ...
                        break;
                    case '`LAVANDERIA`':
                        $stmt->bindValue($identifier, $this->lavanderia, PDO::PARAM_INT);
                        break;
                    case '`ESTADO`':
                    ...
                    case '`PRECIO_NEGOCIABLE`':
                        $stmt->bindValue($identifier, (int) $this->precio_negociable, PDO::PARAM_INT);
                        break;
                    case '`FORMA_PAGO`':
                        $stmt->bindValue($identifier, $this->forma_pago, PDO::PARAM_STR);
                        break;
                    case '`GASTOS_ESCRITURA`':
                        $stmt->bindValue($identifier, (int) $this->gastos_escritura, PDO::PARAM_INT);
                        break;
                    case '`CREATED_AT`':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 40:
                ...
                break;
            case 41:
                return $this->getPrecioNegociable();
                break;
            case 42:
                return $this->getFormaPago();
                break;
            case 43:
                return $this->getGastosEscritura();
                break;
            case 44:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[24] => $this->getMiComision(),
            $keys[25] => $this->getComisionCompartida(),
            $keys[26] => $this->getNombreCliente(),
            $keys[27] => $this->getCorreoCliente(),
            $keys[28] => $this->getTelefonoCliente(),
            $keys[29] => $this->getDepartamentoId(),
            $keys[30] => $this->getMunicipioId(),
            $keys[31] => $this->getZona(),
            $keys[32] => $this->getKm(),
            $keys[33] => $this->getDireccion(),
            $keys[34] => $this->getSeguridad(),
            $keys[35] => $this->getAccesos(),
            $keys[36] => $this->getAgua(),
            $keys[37] => $this->getTransportePublico(),
            $keys[38] => $this->getTransitoVehicular(),
            $keys[39] => $this->getComunidadesColidantes(),
            $keys[40] => $this->getAreasRecreacion(),
            $keys[41] => $this->getPrecioNegociable(),
            $keys[42] => $this->getFormaPago(),
            $keys[43] => $this->getGastosEscritura(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 40:
                ...
                break;
            case 41:
                $this->setPrecioNegociable($value);
                break;
            case 42:
                $this->setFormaPago($value);
                break;
            case 43:
                $this->setGastosEscritura($value);
                break;
            case 44:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[24], $arr)) $this->setMiComision($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setComisionCompartida($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setNombreCliente($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setCorreoCliente($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setTelefonoCliente($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setDepartamentoId($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setMunicipioId($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setZona($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setKm($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setDireccion($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setSeguridad($arr[$keys[34]]);
        if (array_key_exists($keys[35], $arr)) $this->setAccesos($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setAgua($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setTransportePublico($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setTransitoVehicular($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setComunidadesColidantes($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setAreasRecreacion($arr[$keys[40]]);
        if (array_key_exists($keys[41], $arr)) $this->setPrecioNegociable($arr[$keys[41]]);
        if (array_key_exists($keys[42], $arr)) $this->setFormaPago($arr[$keys[42]]);
        if (array_key_exists($keys[43], $arr)) $this->setGastosEscritura($arr[$keys[43]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PropiedadPeer::PRECIO_NEGOCIABLE)) $criteria->add(PropiedadPeer::PRECIO_NEGOCIABLE, $this->precio_negociable);
        if ($this->isColumnModified(PropiedadPeer::FORMA_PAGO)) $criteria->add(PropiedadPeer::FORMA_PAGO, $this->forma_pago);
        if ($this->isColumnModified(PropiedadPeer::GASTOS_ESCRITURA)) $criteria->add(PropiedadPeer::GASTOS_ESCRITURA, $this->gastos_escritura);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPrecioNegociable($this->getPrecioNegociable());
        $copyObj->setFormaPago($this->getFormaPago());
        $copyObj->setGastosEscritura($this->getGastosEscritura());
    ...
    public function clear()
    {
        ...
        $this->precio_negociable = null;
        $this->forma_pago = null;
        $this->gastos_escritura = null;
