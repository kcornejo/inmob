...
abstract class BaseTokenPeer
{
    ...
    const USUARIO_ID = 'token.USUARIO_ID';
    ...
    /** the column name for the UTILIZADO field */
    const UTILIZADO = 'token.UTILIZADO';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UsuarioId', 'Token', 'CreatedAt', 'UpdatedAt', 'Utilizado', 'Tipo', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'usuarioId', 'token', 'createdAt', 'updatedAt', 'utilizado', 'tipo', ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::ID, TokenPeer::USUARIO_ID, TokenPeer::TOKEN, TokenPeer::CREATED_AT, TokenPeer::UPDATED_AT, TokenPeer::UTILIZADO, TokenPeer::TIPO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USUARIO_ID', 'TOKEN', 'CREATED_AT', 'UPDATED_AT', 'UTILIZADO', 'TIPO', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'usuario_id', 'token', 'created_at', 'updated_at', 'utilizado', 'tipo', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UsuarioId' => 1, 'Token' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'Utilizado' => 5, 'Tipo' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'usuarioId' => 1, 'token' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'utilizado' => 5, 'tipo' => 6, ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::ID => 0, TokenPeer::USUARIO_ID => 1, TokenPeer::TOKEN => 2, TokenPeer::CREATED_AT => 3, TokenPeer::UPDATED_AT => 4, TokenPeer::UTILIZADO => 5, TokenPeer::TIPO => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USUARIO_ID' => 1, 'TOKEN' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'UTILIZADO' => 5, 'TIPO' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'usuario_id' => 1, 'token' => 2, 'created_at' => 3, 'updated_at' => 4, 'utilizado' => 5, 'tipo' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TokenPeer::USUARIO_ID);
            ...
            $criteria->addSelectColumn(TokenPeer::UTILIZADO);
            $criteria->addSelectColumn(TokenPeer::TIPO);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.UTILIZADO');
    ...
    public static function doCountJoinUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TokenPeer::USUARIO_ID, UsuarioPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Token objects pre-filled with their Usuario objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Token) to $obj2 (Usuario)
                $obj2->addToken($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Token) to the collection in $obj2 (Usuario)
                $obj2->addToken($obj1);
