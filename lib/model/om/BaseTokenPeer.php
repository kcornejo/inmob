...
abstract class BaseTokenPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UsuarioId', 'Token', 'CreatedAt', 'UpdatedAt', 'Utilizado', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'usuarioId', 'token', 'createdAt', 'updatedAt', 'utilizado', ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::ID, TokenPeer::USUARIO_ID, TokenPeer::TOKEN, TokenPeer::CREATED_AT, TokenPeer::UPDATED_AT, TokenPeer::UTILIZADO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USUARIO_ID', 'TOKEN', 'CREATED_AT', 'UPDATED_AT', 'UTILIZADO', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'usuario_id', 'token', 'created_at', 'updated_at', 'utilizado', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UsuarioId' => 1, 'Token' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'Utilizado' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'usuarioId' => 1, 'token' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'utilizado' => 5, ),
        BasePeer::TYPE_COLNAME => array (TokenPeer::ID => 0, TokenPeer::USUARIO_ID => 1, TokenPeer::TOKEN => 2, TokenPeer::CREATED_AT => 3, TokenPeer::UPDATED_AT => 4, TokenPeer::UTILIZADO => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USUARIO_ID' => 1, 'TOKEN' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'UTILIZADO' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'usuario_id' => 1, 'token' => 2, 'created_at' => 3, 'updated_at' => 4, 'utilizado' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
