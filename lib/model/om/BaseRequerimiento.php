...
abstract class BaseRequerimiento extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->presupuesto_min = ($row[$startcol + 24] !== null) ? (double) $row[$startcol + 24] : null;
            $this->presupuesto_max = ($row[$startcol + 25] !== null) ? (double) $row[$startcol + 25] : null;
            $this->precalificacion = ($row[$startcol + 26] !== null) ? (boolean) $row[$startcol + 26] : null;
            ...
            return $startcol + 30; // 30 = RequerimientoPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[24] => $this->getPresupuestoMin(),
            $keys[25] => $this->getPresupuestoMax(),
            $keys[26] => $this->getPrecalificacion(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[24], $arr)) $this->setPresupuestoMin($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setPresupuestoMax($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setPrecalificacion($arr[$keys[26]]);
