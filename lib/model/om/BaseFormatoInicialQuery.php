 ...
 * @method FormatoInicial findOneByContenido(string $contenido) Return the first FormatoInicial filtered by the contenido column
 *
 * @method array findById(int $id) Return FormatoInicial objects filtered by the id column
 * @method array findByContenido(string $contenido) Return FormatoInicial objects filtered by the contenido column
 *
