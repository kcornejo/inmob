 ...
 * @method RequerimientoQuery orderByCantidadOficina($order = Criteria::ASC) Order by the cantidad_oficina column
 * @method RequerimientoQuery orderByCantidadCubiculo($order = Criteria::ASC) Order by the cantidad_cubiculo column
 *
 ...
 * @method RequerimientoQuery groupByCantidadOficina() Group by the cantidad_oficina column
 * @method RequerimientoQuery groupByCantidadCubiculo() Group by the cantidad_cubiculo column
 *
 ...
 * @method Requerimiento findOneByCantidadOficina(int $cantidad_oficina) Return the first Requerimiento filtered by the cantidad_oficina column
 * @method Requerimiento findOneByCantidadCubiculo(int $cantidad_cubiculo) Return the first Requerimiento filtered by the cantidad_cubiculo column
 *
 ...
 * @method array findByCantidadOficina(int $cantidad_oficina) Return Requerimiento objects filtered by the cantidad_oficina column
 * @method array findByCantidadCubiculo(int $cantidad_cubiculo) Return Requerimiento objects filtered by the cantidad_cubiculo column
 *
    ...
    public function filterByCantidadOficina($cantidadOficina = null, $comparison = null)
    {
        if (is_array($cantidadOficina)) {
            ...
            if (isset($cantidadOficina['min'])) {
                $this->addUsingAlias(RequerimientoPeer::CANTIDAD_OFICINA, $cantidadOficina['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($cantidadOficina['max'])) {
                $this->addUsingAlias(RequerimientoPeer::CANTIDAD_OFICINA, $cantidadOficina['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RequerimientoPeer::CANTIDAD_OFICINA, $cantidadOficina, $comparison);
    }
    ...
    public function filterByCantidadCubiculo($cantidadCubiculo = null, $comparison = null)
    {
        if (is_array($cantidadCubiculo)) {
            ...
            if (isset($cantidadCubiculo['min'])) {
                $this->addUsingAlias(RequerimientoPeer::CANTIDAD_CUBICULO, $cantidadCubiculo['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($cantidadCubiculo['max'])) {
                $this->addUsingAlias(RequerimientoPeer::CANTIDAD_CUBICULO, $cantidadCubiculo['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RequerimientoPeer::CANTIDAD_CUBICULO, $cantidadCubiculo, $comparison);
    }
