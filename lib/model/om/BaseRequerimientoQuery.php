 ...
 * @method RequerimientoQuery orderByMonedaIngreso($order = Criteria::ASC) Order by the moneda_ingreso column
 * @method RequerimientoQuery orderByIngresos($order = Criteria::ASC) Order by the ingresos column
 * @method RequerimientoQuery orderByMonedaEgresos($order = Criteria::ASC) Order by the moneda_egresos column
 ...
 * @method RequerimientoQuery groupByMonedaIngreso() Group by the moneda_ingreso column
 * @method RequerimientoQuery groupByIngresos() Group by the ingresos column
 * @method RequerimientoQuery groupByMonedaEgresos() Group by the moneda_egresos column
 ...
 *
 * @method RequerimientoQuery leftJoinMonedaRelatedByMonedaId($relationAlias = null) Adds a LEFT JOIN clause to the query using the MonedaRelatedByMonedaId relation
 * @method RequerimientoQuery rightJoinMonedaRelatedByMonedaId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MonedaRelatedByMonedaId relation
 * @method RequerimientoQuery innerJoinMonedaRelatedByMonedaId($relationAlias = null) Adds a INNER JOIN clause to the query using the MonedaRelatedByMonedaId relation
 *
 * @method RequerimientoQuery leftJoinMonedaRelatedByMonedaIngreso($relationAlias = null) Adds a LEFT JOIN clause to the query using the MonedaRelatedByMonedaIngreso relation
 * @method RequerimientoQuery rightJoinMonedaRelatedByMonedaIngreso($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MonedaRelatedByMonedaIngreso relation
 * @method RequerimientoQuery innerJoinMonedaRelatedByMonedaIngreso($relationAlias = null) Adds a INNER JOIN clause to the query using the MonedaRelatedByMonedaIngreso relation
 *
 * @method RequerimientoQuery leftJoinMonedaRelatedByMonedaEgresos($relationAlias = null) Adds a LEFT JOIN clause to the query using the MonedaRelatedByMonedaEgresos relation
 * @method RequerimientoQuery rightJoinMonedaRelatedByMonedaEgresos($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MonedaRelatedByMonedaEgresos relation
 * @method RequerimientoQuery innerJoinMonedaRelatedByMonedaEgresos($relationAlias = null) Adds a INNER JOIN clause to the query using the MonedaRelatedByMonedaEgresos relation
 *
 ...
 * @method Requerimiento findOneByCantidadBanio(int $cantidad_banio) Return the first Requerimiento filtered by the cantidad_banio column
 ...
 * @method Requerimiento findOneByMonedaIngreso(int $moneda_ingreso) Return the first Requerimiento filtered by the moneda_ingreso column
 * @method Requerimiento findOneByIngresos(double $ingresos) Return the first Requerimiento filtered by the ingresos column
 * @method Requerimiento findOneByMonedaEgresos(int $moneda_egresos) Return the first Requerimiento filtered by the moneda_egresos column
 ...
 * @method array findByCantidadBanio(int $cantidad_banio) Return Requerimiento objects filtered by the cantidad_banio column
 ...
 * @method array findByMonedaIngreso(int $moneda_ingreso) Return Requerimiento objects filtered by the moneda_ingreso column
 * @method array findByIngresos(double $ingresos) Return Requerimiento objects filtered by the ingresos column
 * @method array findByMonedaEgresos(int $moneda_egresos) Return Requerimiento objects filtered by the moneda_egresos column
...
abstract class BaseRequerimientoQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByMonedaRelatedByMonedaId()
     *
    ...
    /**
     * Filter the query on the moneda_ingreso column
     *
     * Example usage:
     * <code>
     * $query->filterByMonedaIngreso(1234); // WHERE moneda_ingreso = 1234
     * $query->filterByMonedaIngreso(array(12, 34)); // WHERE moneda_ingreso IN (12, 34)
     * $query->filterByMonedaIngreso(array('min' => 12)); // WHERE moneda_ingreso > 12
     * </code>
     *
     * @see       filterByMonedaRelatedByMonedaIngreso()
     *
     * @param     mixed $monedaIngreso The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return RequerimientoQuery The current query, for fluid interface
     */
    public function filterByMonedaIngreso($monedaIngreso = null, $comparison = null)
    {
        if (is_array($monedaIngreso)) {
            $useMinMax = false;
            if (isset($monedaIngreso['min'])) {
                $this->addUsingAlias(RequerimientoPeer::MONEDA_INGRESO, $monedaIngreso['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($monedaIngreso['max'])) {
                $this->addUsingAlias(RequerimientoPeer::MONEDA_INGRESO, $monedaIngreso['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RequerimientoPeer::MONEDA_INGRESO, $monedaIngreso, $comparison);
    }
    ...
    /**
     * Filter the query on the moneda_egresos column
     *
     * Example usage:
     * <code>
     * $query->filterByMonedaEgresos(1234); // WHERE moneda_egresos = 1234
     * $query->filterByMonedaEgresos(array(12, 34)); // WHERE moneda_egresos IN (12, 34)
     * $query->filterByMonedaEgresos(array('min' => 12)); // WHERE moneda_egresos > 12
     * </code>
     *
     * @see       filterByMonedaRelatedByMonedaEgresos()
     *
     * @param     mixed $monedaEgresos The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return RequerimientoQuery The current query, for fluid interface
     */
    public function filterByMonedaEgresos($monedaEgresos = null, $comparison = null)
    {
        if (is_array($monedaEgresos)) {
            $useMinMax = false;
            if (isset($monedaEgresos['min'])) {
                $this->addUsingAlias(RequerimientoPeer::MONEDA_EGRESOS, $monedaEgresos['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($monedaEgresos['max'])) {
                $this->addUsingAlias(RequerimientoPeer::MONEDA_EGRESOS, $monedaEgresos['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RequerimientoPeer::MONEDA_EGRESOS, $monedaEgresos, $comparison);
    }
     ...
     */
    public function filterByMonedaRelatedByMonedaId($moneda, $comparison = null)
    {
        if ($moneda instanceof Moneda) {
            ...
            throw new PropelException('filterByMonedaRelatedByMonedaId() only accepts arguments of type Moneda or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the MonedaRelatedByMonedaId relation
     *
     ...
     * @return RequerimientoQuery The current query, for fluid interface
     */
    public function joinMonedaRelatedByMonedaId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('MonedaRelatedByMonedaId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'MonedaRelatedByMonedaId');
        }
    ...
    /**
     * Use the MonedaRelatedByMonedaId relation Moneda object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useMonedaRelatedByMonedaIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinMonedaRelatedByMonedaId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'MonedaRelatedByMonedaId', 'MonedaQuery');
    }
     ...
     * @throws   PropelException - if the provided filter is invalid.
     */
    public function filterByMonedaRelatedByMonedaIngreso($moneda, $comparison = null)
    {
        if ($moneda instanceof Moneda) {
            return $this
                ->addUsingAlias(RequerimientoPeer::MONEDA_INGRESO, $moneda->getId(), $comparison);
        } elseif ($moneda instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(RequerimientoPeer::MONEDA_INGRESO, $moneda->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByMonedaRelatedByMonedaIngreso() only accepts arguments of type Moneda or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the MonedaRelatedByMonedaIngreso relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return RequerimientoQuery The current query, for fluid interface
     */
    public function joinMonedaRelatedByMonedaIngreso($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('MonedaRelatedByMonedaIngreso');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'MonedaRelatedByMonedaIngreso');
        }
    ...
    /**
     * Use the MonedaRelatedByMonedaIngreso relation Moneda object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   MonedaQuery A secondary query class using the current class as primary query
     */
    public function useMonedaRelatedByMonedaIngresoQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinMonedaRelatedByMonedaIngreso($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'MonedaRelatedByMonedaIngreso', 'MonedaQuery');
    }
     ...
     * @throws   PropelException - if the provided filter is invalid.
     */
    public function filterByMonedaRelatedByMonedaEgresos($moneda, $comparison = null)
    {
        if ($moneda instanceof Moneda) {
            return $this
                ->addUsingAlias(RequerimientoPeer::MONEDA_EGRESOS, $moneda->getId(), $comparison);
        } elseif ($moneda instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(RequerimientoPeer::MONEDA_EGRESOS, $moneda->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByMonedaRelatedByMonedaEgresos() only accepts arguments of type Moneda or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the MonedaRelatedByMonedaEgresos relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return RequerimientoQuery The current query, for fluid interface
     */
    public function joinMonedaRelatedByMonedaEgresos($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('MonedaRelatedByMonedaEgresos');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'MonedaRelatedByMonedaEgresos');
        }
    ...
    /**
     * Use the MonedaRelatedByMonedaEgresos relation Moneda object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   MonedaQuery A secondary query class using the current class as primary query
     */
    public function useMonedaRelatedByMonedaEgresosQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinMonedaRelatedByMonedaEgresos($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'MonedaRelatedByMonedaEgresos', 'MonedaQuery');
    }
