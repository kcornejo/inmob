...
abstract class BaseUsuario extends BaseObject implements Persistent
{
    ...
    /**
     * Sets the value of the [borrado] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->borrado = ($row[$startcol + 14] !== null) ? (boolean) $row[$startcol + 14] : null;
            $this->resetModified();
            ...
            return $startcol + 15; // 15 = UsuarioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsuarioPeer::BORRADO)) {
            $modifiedColumns[':p' . $index++]  = '`BORRADO`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`NOMBRE_COMPLETO`':
                        ...
                        break;
                    case '`BORRADO`':
                        $stmt->bindValue($identifier, (int) $this->borrado, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[14], $arr)) $this->setBorrado($arr[$keys[14]]);
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBorrado($this->getBorrado());
    ...
    public function setMensajeNegocios(PropelCollection $mensajeNegocios, PropelPDO $con = null)
    {
        ...
        foreach ($this->mensajeNegociosScheduledForDeletion as $mensajeNegocioRemoved) {
            $mensajeNegocioRemoved->setUsuario(null);
        }
    ...
    protected function doAddMensajeNegocio($mensajeNegocio)
    {
        ...
        $mensajeNegocio->setUsuario($this);
    }
    ...
    public function removeMensajeNegocio($mensajeNegocio)
    {
        if ($this->getMensajeNegocios()->contains($mensajeNegocio)) {
            ...
            $mensajeNegocio->setUsuario(null);
        }
    }
     ...
     * @return PropelObjectCollection|MensajeNegocio[] List of MensajeNegocio objects
     */
    public function getMensajeNegociosJoinNegocio($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = MensajeNegocioQuery::create(null, $criteria);
        $query->joinWith('Negocio', $join_behavior);
