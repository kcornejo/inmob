...
abstract class BaseUsuario extends BaseObject implements Persistent
{
     ...
     * @return PropelObjectCollection|Requerimiento[] List of Requerimiento objects
     */
    public function getRequerimientosJoinMonedaRelatedByMonedaId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RequerimientoQuery::create(null, $criteria);
        $query->joinWith('MonedaRelatedByMonedaId', $join_behavior);
     ...
     * @return PropelObjectCollection|Requerimiento[] List of Requerimiento objects
     */
    public function getRequerimientosJoinMonedaRelatedByMonedaIngreso($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RequerimientoQuery::create(null, $criteria);
        $query->joinWith('MonedaRelatedByMonedaIngreso', $join_behavior);
     ...
     * @return PropelObjectCollection|Requerimiento[] List of Requerimiento objects
     */
    public function getRequerimientosJoinMonedaRelatedByMonedaEgresos($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RequerimientoQuery::create(null, $criteria);
        $query->joinWith('MonedaRelatedByMonedaEgresos', $join_behavior);
