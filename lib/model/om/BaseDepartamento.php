...
abstract class BaseDepartamento extends BaseObject implements Persistent
{
            ...
            if ($this->municipiosScheduledForDeletion !== null) {
                if (!$this->municipiosScheduledForDeletion->isEmpty()) {
                    MunicipioQuery::create()
                        ->filterByPrimaryKeys($this->municipiosScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    public function setDireccionRequerimientos(PropelCollection $direccionRequerimientos, PropelPDO $con = null)
    {
        ...
        foreach ($this->direccionRequerimientosScheduledForDeletion as $direccionRequerimientoRemoved) {
            $direccionRequerimientoRemoved->setDepartamento(null);
        }
    ...
    protected function doAddDireccionRequerimiento($direccionRequerimiento)
    {
        ...
        $direccionRequerimiento->setDepartamento($this);
    }
    ...
    public function removeDireccionRequerimiento($direccionRequerimiento)
    {
        if ($this->getDireccionRequerimientos()->contains($direccionRequerimiento)) {
            ...
            $direccionRequerimiento->setDepartamento(null);
        }
    }
