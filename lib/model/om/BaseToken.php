...
abstract class BaseToken extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the utilizado field.
    ...
    /**
     * Initializes internal state of BaseToken object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [utilizado] column value.
     *
     * @return boolean
     */
    ...
    public function setUsuarioId($v)
    {
        ...
        if ($this->usuario_id !== $v) {
            $this->usuario_id = $v;
            $this->modifiedColumns[] = TokenPeer::USUARIO_ID;
        }
    ...
    /**
     * Sets the value of the [utilizado] column.
     ...
     * @return Token The current object (for fluent API support)
     */
    public function setUtilizado($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->utilizado !== $v) {
            $this->utilizado = $v;
            $this->modifiedColumns[] = TokenPeer::UTILIZADO;
        }
    ...
    public function setTipo($v)
    {
        ...
        if ($this->tipo !== $v) {
            $this->tipo = $v;
            $this->modifiedColumns[] = TokenPeer::TIPO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->utilizado = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
            ...
            return $startcol + 7; // 7 = TokenPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TokenPeer::USUARIO_ID)) {
        ...
        if ($this->isColumnModified(TokenPeer::UTILIZADO)) {
            $modifiedColumns[':p' . $index++]  = '`UTILIZADO`';
        }
        if ($this->isColumnModified(TokenPeer::TIPO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`UPDATED_AT`':
                        ...
                        break;
                    case '`UTILIZADO`':
                        $stmt->bindValue($identifier, (int) $this->utilizado, PDO::PARAM_INT);
                        break;
                    case '`TIPO`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setUtilizado($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TokenPeer::USUARIO_ID)) $criteria->add(TokenPeer::USUARIO_ID, $this->usuario_id);
        ...
        if ($this->isColumnModified(TokenPeer::UTILIZADO)) $criteria->add(TokenPeer::UTILIZADO, $this->utilizado);
        if ($this->isColumnModified(TokenPeer::TIPO)) $criteria->add(TokenPeer::TIPO, $this->tipo);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUtilizado($this->getUtilizado());
     ...
     *
     * @return string The value of the 'token' column
     */
