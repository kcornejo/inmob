 ...
 * @method NegocioQuery orderByActivo($order = Criteria::ASC) Order by the activo column
 * @method NegocioQuery orderByUsuarioReqVisto($order = Criteria::ASC) Order by the usuario_req_visto column
 * @method NegocioQuery orderByUsuarioPropVisto($order = Criteria::ASC) Order by the usuario_prop_visto column
 *
 ...
 * @method NegocioQuery groupByActivo() Group by the activo column
 * @method NegocioQuery groupByUsuarioReqVisto() Group by the usuario_req_visto column
 * @method NegocioQuery groupByUsuarioPropVisto() Group by the usuario_prop_visto column
 *
 ...
 *
 * @method NegocioQuery leftJoinMensajeNegocio($relationAlias = null) Adds a LEFT JOIN clause to the query using the MensajeNegocio relation
 * @method NegocioQuery rightJoinMensajeNegocio($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MensajeNegocio relation
 * @method NegocioQuery innerJoinMensajeNegocio($relationAlias = null) Adds a INNER JOIN clause to the query using the MensajeNegocio relation
 *
 ...
 * @method Negocio findOneByActivo(boolean $activo) Return the first Negocio filtered by the activo column
 * @method Negocio findOneByUsuarioReqVisto(boolean $usuario_req_visto) Return the first Negocio filtered by the usuario_req_visto column
 * @method Negocio findOneByUsuarioPropVisto(boolean $usuario_prop_visto) Return the first Negocio filtered by the usuario_prop_visto column
 *
 ...
 * @method array findByActivo(boolean $activo) Return Negocio objects filtered by the activo column
 * @method array findByUsuarioReqVisto(boolean $usuario_req_visto) Return Negocio objects filtered by the usuario_req_visto column
 * @method array findByUsuarioPropVisto(boolean $usuario_prop_visto) Return Negocio objects filtered by the usuario_prop_visto column
 *
...
abstract class BaseNegocioQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `REQUERIMIENTO_ID`, `PROPIEDAD_ID`, `USUARIO_REQ`, `USUARIO_PROP`, `ACTIVO`, `USUARIO_REQ_VISTO`, `USUARIO_PROP_VISTO` FROM `negocio` WHERE `ID` = :p0';
        try {
    ...
    public function filterByActivo($activo = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NegocioPeer::ACTIVO, $activo, $comparison);
    }

    /**
     * Filter the query on the usuario_req_visto column
     *
     * Example usage:
     * <code>
     * $query->filterByUsuarioReqVisto(true); // WHERE usuario_req_visto = true
     * $query->filterByUsuarioReqVisto('yes'); // WHERE usuario_req_visto = true
     * </code>
     *
     * @param     boolean|string $usuarioReqVisto The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return NegocioQuery The current query, for fluid interface
     */
    public function filterByUsuarioReqVisto($usuarioReqVisto = null, $comparison = null)
    {
        if (is_string($usuarioReqVisto)) {
            $usuario_req_visto = in_array(strtolower($usuarioReqVisto), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(NegocioPeer::USUARIO_REQ_VISTO, $usuarioReqVisto, $comparison);
    }

    /**
     * Filter the query on the usuario_prop_visto column
     *
     * Example usage:
     * <code>
     * $query->filterByUsuarioPropVisto(true); // WHERE usuario_prop_visto = true
     * $query->filterByUsuarioPropVisto('yes'); // WHERE usuario_prop_visto = true
     * </code>
     *
     * @param     boolean|string $usuarioPropVisto The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return NegocioQuery The current query, for fluid interface
     */
    public function filterByUsuarioPropVisto($usuarioPropVisto = null, $comparison = null)
    {
        if (is_string($usuarioPropVisto)) {
            $usuario_prop_visto = in_array(strtolower($usuarioPropVisto), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(NegocioPeer::USUARIO_PROP_VISTO, $usuarioPropVisto, $comparison);
    }
    ...
    public function filterByMensajeNegocio($mensajeNegocio, $comparison = null)
    {
        if ($mensajeNegocio instanceof MensajeNegocio) {
            return $this
                ->addUsingAlias(NegocioPeer::ID, $mensajeNegocio->getNegocioId(), $comparison);
