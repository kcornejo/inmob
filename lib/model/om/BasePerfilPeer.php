...
abstract class BasePerfilPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Descripcion', 'Activo', 'CreatedAt', 'UpdatedAt', 'CreatedBy', 'UpdatedBy', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'descripcion', 'activo', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', ),
        BasePeer::TYPE_COLNAME => array (PerfilPeer::ID, PerfilPeer::DESCRIPCION, PerfilPeer::ACTIVO, PerfilPeer::CREATED_AT, PerfilPeer::UPDATED_AT, PerfilPeer::CREATED_BY, PerfilPeer::UPDATED_BY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DESCRIPCION', 'ACTIVO', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', 'UPDATED_BY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'descripcion', 'activo', 'created_at', 'updated_at', 'created_by', 'updated_by', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Descripcion' => 1, 'Activo' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'CreatedBy' => 5, 'UpdatedBy' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'descripcion' => 1, 'activo' => 2, 'createdAt' => 3, 'updatedAt' => 4, 'createdBy' => 5, 'updatedBy' => 6, ),
        BasePeer::TYPE_COLNAME => array (PerfilPeer::ID => 0, PerfilPeer::DESCRIPCION => 1, PerfilPeer::ACTIVO => 2, PerfilPeer::CREATED_AT => 3, PerfilPeer::UPDATED_AT => 4, PerfilPeer::CREATED_BY => 5, PerfilPeer::UPDATED_BY => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DESCRIPCION' => 1, 'ACTIVO' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, 'CREATED_BY' => 5, 'UPDATED_BY' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'descripcion' => 1, 'activo' => 2, 'created_at' => 3, 'updated_at' => 4, 'created_by' => 5, 'updated_by' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
