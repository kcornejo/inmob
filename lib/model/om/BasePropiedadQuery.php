...
abstract class BasePropiedadQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `TIPO_OPERACION`, `TIPO_INMUEBLE`, `CANTIDAD_HABITACION`, `CANTIDAD_BANIO`, `CANTIDAD_PARQUEO`, `CANTIDAD_COMEDOR`, `CANTIDAD_SALA`, `CANTIDAD_COCINA`, `DORMITORIO_SERVICIO`, `ESTUDIO`, `CISTERNA`, `CANTIDAD_JARDIN`, `CANTIDAD_PATIO`, `LAVANDERIA`, `ESTADO`, `AMENIDADES`, `PRECIO`, `NEGOCIABLE`, `INCLUYE_GASTOS_ESCRITURA`, `ANIO_CONSTRUCCION`, `MANTENIMIENTO_MENSUAL`, `IUSI_SEMESTRAL`, `VALOR_AVALUO`, `CREATED_AT`, `UPDATED_AT`, `CREATED_BY`, `UPDATED_BY` FROM `propiedad` WHERE `ID` = :p0';
        try {
