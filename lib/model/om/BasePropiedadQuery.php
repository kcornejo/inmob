 ...
 * @method PropiedadQuery orderByEstatus($order = Criteria::ASC) Order by the estatus column
 * @method PropiedadQuery orderByUsuarioId($order = Criteria::ASC) Order by the usuario_id column
 * @method PropiedadQuery orderByCantidadOficina($order = Criteria::ASC) Order by the cantidad_oficina column
 * @method PropiedadQuery orderByCantidadCubiculo($order = Criteria::ASC) Order by the cantidad_cubiculo column
 * @method PropiedadQuery orderByContrato($order = Criteria::ASC) Order by the contrato column
 * @method PropiedadQuery orderByMantenimientoRenta($order = Criteria::ASC) Order by the mantenimiento_renta column
 *
 ...
 * @method PropiedadQuery groupByEstatus() Group by the estatus column
 * @method PropiedadQuery groupByUsuarioId() Group by the usuario_id column
 * @method PropiedadQuery groupByCantidadOficina() Group by the cantidad_oficina column
 * @method PropiedadQuery groupByCantidadCubiculo() Group by the cantidad_cubiculo column
 * @method PropiedadQuery groupByContrato() Group by the contrato column
 * @method PropiedadQuery groupByMantenimientoRenta() Group by the mantenimiento_renta column
 *
 ...
 *
 * @method PropiedadQuery leftJoinUsuario($relationAlias = null) Adds a LEFT JOIN clause to the query using the Usuario relation
 * @method PropiedadQuery rightJoinUsuario($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Usuario relation
 * @method PropiedadQuery innerJoinUsuario($relationAlias = null) Adds a INNER JOIN clause to the query using the Usuario relation
 *
 * @method PropiedadQuery leftJoinNegocio($relationAlias = null) Adds a LEFT JOIN clause to the query using the Negocio relation
 * @method PropiedadQuery rightJoinNegocio($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Negocio relation
 * @method PropiedadQuery innerJoinNegocio($relationAlias = null) Adds a INNER JOIN clause to the query using the Negocio relation
 *
 ...
 * @method Propiedad findOneByCantidadBanio(double $cantidad_banio) Return the first Propiedad filtered by the cantidad_banio column
 ...
 * @method Propiedad findOneByEstatus(string $estatus) Return the first Propiedad filtered by the estatus column
 * @method Propiedad findOneByUsuarioId(int $usuario_id) Return the first Propiedad filtered by the usuario_id column
 * @method Propiedad findOneByCantidadOficina(int $cantidad_oficina) Return the first Propiedad filtered by the cantidad_oficina column
 * @method Propiedad findOneByCantidadCubiculo(int $cantidad_cubiculo) Return the first Propiedad filtered by the cantidad_cubiculo column
 * @method Propiedad findOneByContrato(boolean $contrato) Return the first Propiedad filtered by the contrato column
 * @method Propiedad findOneByMantenimientoRenta(double $mantenimiento_renta) Return the first Propiedad filtered by the mantenimiento_renta column
 *
 ...
 * @method array findByCantidadBanio(double $cantidad_banio) Return Propiedad objects filtered by the cantidad_banio column
 ...
 * @method array findByEstatus(string $estatus) Return Propiedad objects filtered by the estatus column
 * @method array findByUsuarioId(int $usuario_id) Return Propiedad objects filtered by the usuario_id column
 * @method array findByCantidadOficina(int $cantidad_oficina) Return Propiedad objects filtered by the cantidad_oficina column
 * @method array findByCantidadCubiculo(int $cantidad_cubiculo) Return Propiedad objects filtered by the cantidad_cubiculo column
 * @method array findByContrato(boolean $contrato) Return Propiedad objects filtered by the contrato column
 * @method array findByMantenimientoRenta(double $mantenimiento_renta) Return Propiedad objects filtered by the mantenimiento_renta column
 *
...
abstract class BasePropiedadQuery extends ModelCriteria
{
    ...
    public function filterByEstatus($estatus = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PropiedadPeer::ESTATUS, $estatus, $comparison);
    }
    ...
    public function filterByUsuarioId($usuarioId = null, $comparison = null)
    {
        if (is_array($usuarioId)) {
            ...
            if (isset($usuarioId['min'])) {
                $this->addUsingAlias(PropiedadPeer::USUARIO_ID, $usuarioId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($usuarioId['max'])) {
                $this->addUsingAlias(PropiedadPeer::USUARIO_ID, $usuarioId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropiedadPeer::USUARIO_ID, $usuarioId, $comparison);
    }

    /**
     * Filter the query on the cantidad_oficina column
     *
     * Example usage:
     * <code>
     * $query->filterByCantidadOficina(1234); // WHERE cantidad_oficina = 1234
     * $query->filterByCantidadOficina(array(12, 34)); // WHERE cantidad_oficina IN (12, 34)
     * $query->filterByCantidadOficina(array('min' => 12)); // WHERE cantidad_oficina > 12
     * </code>
     *
     * @param     mixed $cantidadOficina The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return PropiedadQuery The current query, for fluid interface
     */
    public function filterByCantidadOficina($cantidadOficina = null, $comparison = null)
    {
        if (is_array($cantidadOficina)) {
            $useMinMax = false;
            if (isset($cantidadOficina['min'])) {
                $this->addUsingAlias(PropiedadPeer::CANTIDAD_OFICINA, $cantidadOficina['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($cantidadOficina['max'])) {
                $this->addUsingAlias(PropiedadPeer::CANTIDAD_OFICINA, $cantidadOficina['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropiedadPeer::CANTIDAD_OFICINA, $cantidadOficina, $comparison);
    }

    /**
     * Filter the query on the cantidad_cubiculo column
     *
     * Example usage:
     * <code>
     * $query->filterByCantidadCubiculo(1234); // WHERE cantidad_cubiculo = 1234
     * $query->filterByCantidadCubiculo(array(12, 34)); // WHERE cantidad_cubiculo IN (12, 34)
     * $query->filterByCantidadCubiculo(array('min' => 12)); // WHERE cantidad_cubiculo > 12
     * </code>
     *
     * @param     mixed $cantidadCubiculo The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return PropiedadQuery The current query, for fluid interface
     */
    public function filterByCantidadCubiculo($cantidadCubiculo = null, $comparison = null)
    {
        if (is_array($cantidadCubiculo)) {
            $useMinMax = false;
            if (isset($cantidadCubiculo['min'])) {
                $this->addUsingAlias(PropiedadPeer::CANTIDAD_CUBICULO, $cantidadCubiculo['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($cantidadCubiculo['max'])) {
                $this->addUsingAlias(PropiedadPeer::CANTIDAD_CUBICULO, $cantidadCubiculo['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropiedadPeer::CANTIDAD_CUBICULO, $cantidadCubiculo, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByContrato(true); // WHERE contrato = true
     * $query->filterByContrato('yes'); // WHERE contrato = true
     * </code>
     *
     * @param     boolean|string $contrato The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function filterByContrato($contrato = null, $comparison = null)
    {
        if (is_string($contrato)) {
            $contrato = in_array(strtolower($contrato), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(PropiedadPeer::CONTRATO, $contrato, $comparison);
    }

    /**
     * Filter the query on the mantenimiento_renta column
     *
     * Example usage:
     * <code>
     * $query->filterByMantenimientoRenta(1234); // WHERE mantenimiento_renta = 1234
     * $query->filterByMantenimientoRenta(array(12, 34)); // WHERE mantenimiento_renta IN (12, 34)
     * $query->filterByMantenimientoRenta(array('min' => 12)); // WHERE mantenimiento_renta > 12
     * </code>
     *
     * @param     mixed $mantenimientoRenta The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return PropiedadQuery The current query, for fluid interface
     */
    public function filterByMantenimientoRenta($mantenimientoRenta = null, $comparison = null)
    {
        if (is_array($mantenimientoRenta)) {
            $useMinMax = false;
            if (isset($mantenimientoRenta['min'])) {
                $this->addUsingAlias(PropiedadPeer::MANTENIMIENTO_RENTA, $mantenimientoRenta['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($mantenimientoRenta['max'])) {
                $this->addUsingAlias(PropiedadPeer::MANTENIMIENTO_RENTA, $mantenimientoRenta['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PropiedadPeer::MANTENIMIENTO_RENTA, $mantenimientoRenta, $comparison);
    }
    ...
    public function filterByUsuario($usuario, $comparison = null)
    {
        if ($usuario instanceof Usuario) {
            return $this
                ->addUsingAlias(PropiedadPeer::USUARIO_ID, $usuario->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PropiedadPeer::USUARIO_ID, $usuario->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByNegocio($negocio, $comparison = null)
    {
        if ($negocio instanceof Negocio) {
            return $this
                ->addUsingAlias(PropiedadPeer::ID, $negocio->getPropiedadId(), $comparison);
     ...
     * @return PropiedadQuery The current query, for fluid interface
     */
    public function joinPropiedadImagen($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function usePropiedadImagenQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
