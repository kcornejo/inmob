 ...
 * @method PropiedadQuery orderByPrecioNegociable($order = Criteria::ASC) Order by the precio_negociable column
 * @method PropiedadQuery orderByFormaPago($order = Criteria::ASC) Order by the forma_pago column
 * @method PropiedadQuery orderByGastosEscritura($order = Criteria::ASC) Order by the gastos_escritura column
 ...
 * @method PropiedadQuery groupByPrecioNegociable() Group by the precio_negociable column
 * @method PropiedadQuery groupByFormaPago() Group by the forma_pago column
 * @method PropiedadQuery groupByGastosEscritura() Group by the gastos_escritura column
 ...
 * @method Propiedad findOneByDormitorioServicio(int $dormitorio_servicio) Return the first Propiedad filtered by the dormitorio_servicio column
 * @method Propiedad findOneByEstudio(int $estudio) Return the first Propiedad filtered by the estudio column
 * @method Propiedad findOneByCisterna(int $cisterna) Return the first Propiedad filtered by the cisterna column
 ...
 * @method Propiedad findOneByLavanderia(int $lavanderia) Return the first Propiedad filtered by the lavanderia column
 ...
 * @method Propiedad findOneByPrecioNegociable(boolean $precio_negociable) Return the first Propiedad filtered by the precio_negociable column
 * @method Propiedad findOneByFormaPago(string $forma_pago) Return the first Propiedad filtered by the forma_pago column
 * @method Propiedad findOneByGastosEscritura(boolean $gastos_escritura) Return the first Propiedad filtered by the gastos_escritura column
 ...
 * @method array findByDormitorioServicio(int $dormitorio_servicio) Return Propiedad objects filtered by the dormitorio_servicio column
 * @method array findByEstudio(int $estudio) Return Propiedad objects filtered by the estudio column
 * @method array findByCisterna(int $cisterna) Return Propiedad objects filtered by the cisterna column
 ...
 * @method array findByLavanderia(int $lavanderia) Return Propiedad objects filtered by the lavanderia column
 ...
 * @method array findByPrecioNegociable(boolean $precio_negociable) Return Propiedad objects filtered by the precio_negociable column
 * @method array findByFormaPago(string $forma_pago) Return Propiedad objects filtered by the forma_pago column
 * @method array findByGastosEscritura(boolean $gastos_escritura) Return Propiedad objects filtered by the gastos_escritura column
...
abstract class BasePropiedadQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `TIPO_OPERACION`, `TIPO_INMUEBLE`, `CANTIDAD_HABITACION`, `CANTIDAD_BANIO`, `CANTIDAD_PARQUEO`, `CANTIDAD_COMEDOR`, `CANTIDAD_SALA`, `CANTIDAD_COCINA`, `DORMITORIO_SERVICIO`, `ESTUDIO`, `CISTERNA`, `CANTIDAD_JARDIN`, `CANTIDAD_PATIO`, `LAVANDERIA`, `ESTADO`, `AMENIDADES`, `PRECIO`, `NEGOCIABLE`, `INCLUYE_GASTOS_ESCRITURA`, `ANIO_CONSTRUCCION`, `MANTENIMIENTO_MENSUAL`, `IUSI_SEMESTRAL`, `VALOR_AVALUO`, `MI_COMISION`, `COMISION_COMPARTIDA`, `NOMBRE_CLIENTE`, `CORREO_CLIENTE`, `TELEFONO_CLIENTE`, `DEPARTAMENTO_ID`, `MUNICIPIO_ID`, `ZONA`, `KM`, `DIRECCION`, `SEGURIDAD`, `ACCESOS`, `AGUA`, `TRANSPORTE_PUBLICO`, `TRANSITO_VEHICULAR`, `COMUNIDADES_COLIDANTES`, `AREAS_RECREACION`, `PRECIO_NEGOCIABLE`, `FORMA_PAGO`, `GASTOS_ESCRITURA`, `CREATED_AT`, `UPDATED_AT`, `CREATED_BY`, `UPDATED_BY` FROM `propiedad` WHERE `ID` = :p0';
        try {
     ...
     * Example usage:
     * <code>
     * $query->filterByDormitorioServicio(1234); // WHERE dormitorio_servicio = 1234
     * $query->filterByDormitorioServicio(array(12, 34)); // WHERE dormitorio_servicio IN (12, 34)
     * $query->filterByDormitorioServicio(array('min' => 12)); // WHERE dormitorio_servicio > 12
     * </code>
     *
     * @param     mixed $dormitorioServicio The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
    ...
    {
        if (is_array($dormitorioServicio)) {
            $useMinMax = false;
            if (isset($dormitorioServicio['min'])) {
                $this->addUsingAlias(PropiedadPeer::DORMITORIO_SERVICIO, $dormitorioServicio['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dormitorioServicio['max'])) {
                $this->addUsingAlias(PropiedadPeer::DORMITORIO_SERVICIO, $dormitorioServicio['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     * Example usage:
     * <code>
     * $query->filterByEstudio(1234); // WHERE estudio = 1234
     * $query->filterByEstudio(array(12, 34)); // WHERE estudio IN (12, 34)
     * $query->filterByEstudio(array('min' => 12)); // WHERE estudio > 12
     * </code>
     *
     * @param     mixed $estudio The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
    ...
    public function filterByEstudio($estudio = null, $comparison = null)
    {
        if (is_array($estudio)) {
            $useMinMax = false;
            if (isset($estudio['min'])) {
                $this->addUsingAlias(PropiedadPeer::ESTUDIO, $estudio['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($estudio['max'])) {
                $this->addUsingAlias(PropiedadPeer::ESTUDIO, $estudio['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     * Example usage:
     * <code>
     * $query->filterByCisterna(1234); // WHERE cisterna = 1234
     * $query->filterByCisterna(array(12, 34)); // WHERE cisterna IN (12, 34)
     * $query->filterByCisterna(array('min' => 12)); // WHERE cisterna > 12
     * </code>
     *
     * @param     mixed $cisterna The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
    ...
    {
        if (is_array($cisterna)) {
            $useMinMax = false;
            if (isset($cisterna['min'])) {
                $this->addUsingAlias(PropiedadPeer::CISTERNA, $cisterna['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($cisterna['max'])) {
                $this->addUsingAlias(PropiedadPeer::CISTERNA, $cisterna['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     * Example usage:
     * <code>
     * $query->filterByLavanderia(1234); // WHERE lavanderia = 1234
     * $query->filterByLavanderia(array(12, 34)); // WHERE lavanderia IN (12, 34)
     * $query->filterByLavanderia(array('min' => 12)); // WHERE lavanderia > 12
     * </code>
     *
     * @param     mixed $lavanderia The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
    ...
    {
        if (is_array($lavanderia)) {
            $useMinMax = false;
            if (isset($lavanderia['min'])) {
                $this->addUsingAlias(PropiedadPeer::LAVANDERIA, $lavanderia['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lavanderia['max'])) {
                $this->addUsingAlias(PropiedadPeer::LAVANDERIA, $lavanderia['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    /**
     * Filter the query on the precio_negociable column
     *
     * Example usage:
     * <code>
     * $query->filterByPrecioNegociable(true); // WHERE precio_negociable = true
     * $query->filterByPrecioNegociable('yes'); // WHERE precio_negociable = true
     * </code>
     *
     * @param     boolean|string $precioNegociable The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return PropiedadQuery The current query, for fluid interface
     */
    public function filterByPrecioNegociable($precioNegociable = null, $comparison = null)
    {
        if (is_string($precioNegociable)) {
            $precio_negociable = in_array(strtolower($precioNegociable), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(PropiedadPeer::PRECIO_NEGOCIABLE, $precioNegociable, $comparison);
    }
    ...
    /**
     * Filter the query on the gastos_escritura column
     *
     * Example usage:
     * <code>
     * $query->filterByGastosEscritura(true); // WHERE gastos_escritura = true
     * $query->filterByGastosEscritura('yes'); // WHERE gastos_escritura = true
     * </code>
     *
     * @param     boolean|string $gastosEscritura The value to use as filter.
     *              Non-boolean arguments are converted using the following rules:
     *                * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *                * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     *              Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
     ...
     * @return PropiedadQuery The current query, for fluid interface
     */
    public function filterByGastosEscritura($gastosEscritura = null, $comparison = null)
    {
        if (is_string($gastosEscritura)) {
            $gastos_escritura = in_array(strtolower($gastosEscritura), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
        }

        return $this->addUsingAlias(PropiedadPeer::GASTOS_ESCRITURA, $gastosEscritura, $comparison);
    }
