...
abstract class sfModelGeneratorHelper
{
  ...
  {
    return link_to(__($params['label'], array(), 'sf_admin'), '@'.$this->getUrlForAction('new'), array('class' => 'btn btn-success'));
  }

  public function linkToEdit($object, $params)
  {
    return link_to(__($params['label'], array(), 'sf_admin'), $this->getUrlForAction('edit'), $object, array('class' => 'btn btn-warning'));
  }
  ...
  public function linkToSaveAndAdd($object, $params)
  {
    ...
    return '<input class="btn btn-info" type="submit" value="'.__($params['label'], array(), 'sf_admin').'" name="_save_and_add" />';
  }
}
